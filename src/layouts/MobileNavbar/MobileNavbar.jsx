...
export default function Navbar() {
  ...
  useEffect(() => {
    if (isOpen) {
      document.body.classList.add(style.blur);
    } else {
      document.body.classList.remove(style.blur);
    }

    return () => {
      document.body.classList.remove(style.blur); // Clean up the effect on unmount
    };
  }, [isOpen]);
